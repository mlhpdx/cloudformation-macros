...
aws cloudformation deploy --stack-name cfn-macros --template-file cfn-macros.template.published --no-fail-on-empty-changeset --parameter-overrides --capabilities CAPABILITY_IAM CAPABILITY_AUTO_EXPAND --region us-west-2
